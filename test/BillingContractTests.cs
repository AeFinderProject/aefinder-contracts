...
public class BillingContractTests : TestBase
{
    ...
    public async Task LockFromTest()
    {
        ...
        locked.BillingId.ShouldBe(billingId);
    ...
    public async Task LockFromWithExceptionTest()
    {
        ...
        result.TransactionResult.Error.ShouldContain("Invalid billing id");
    ...
    public async Task ChargeTest()
    {
        ...
        charged.Address.ShouldBe(organizationAddress);
        ...
        feeReceived.UserAddress.ShouldBe(organizationAddress);
